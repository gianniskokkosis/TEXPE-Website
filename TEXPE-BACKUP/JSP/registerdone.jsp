...
if(request.getAttribute("uobj") != null) {
    
    user = (User) request.getAttribute("uobj");
...
<head>
    ...
    <meta name="description" content="registerDoneTEXPE">
            ...
            <div class="container" >
                <div class="login-wrap">
                    <div class="login-content" style="background-color: #022C38">
                        <div class="page-header" style="color: aliceblue">
                            <h1><font color="aliceblue">Register Done</font></h1>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-md-10 col-lg-8" ">
                                <h2><font color="aliceblue">Your registration completed successfully!</font></h2>
                                <div class="alert alert-light">
                                    <b>User Details:</b> <%=user%>                   
                                </div>
                            </div>
                        </div>
                        <a href="./today.jsp" class="button">Now, it's time to login!</a>
