...
public class DB {
    ...
    private final String dbName = "ismgroup35";
    private final String dbusername = "ismgroup35";
    private final String dbpassword = "zkne37";

    private Connection con = null;

    /**
     * Establishes a connection with the TEXPE database, initializes and returns the
     * Connection object.
     *
